            ...
            <Row className='m-0'>
                ...
                <Col xl={4} lg={4} md={4} sm={4} xs={4} className='nav_menuu'>
                    <div className='' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap:30, height: '75px' }} >
                        <div>
                            <p className='nav_menu' style={{ margin: 0 }}><a style={{color:'white'}} href='#about-us'>About us</a></p>
                        </div>
                        <div>
                            <p className='nav_menu' style={{ margin: 0 }}><a style={{color:'white'}} href='#team'>Team</a></p>
                        </div>
                        <div>
                            <p className='nav_menu' style={{ margin: 0 }}><a style={{color:'white'}} href='#contact'>Contact</a></p>
                        </div>
                        <div>
                            <p className='nav_menu' style={{ margin: 0 }}><a style={{color:'white'}} href='#blog'>Blog</a></p>
                        </div>
                    </div>
                </Col>
                ...
                <Col xl={2} lg={2} md={6} sm={6} xs={6}>
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '75px' }} >
                        <div>
                            <Button className={'market_place_btn'} btnText={'Register'} onClick={() => navigate('')}
                            />
                        </div>
                    </div>
                </Col>
